...
public class BaseSecuredCrudRepositoryServedOwner<TEntity, TId, TOwner> : ISecuredCrudRepository<TEntity, TId, TOwner>
    where TEntity : BaseOwnedEntity<TId, TOwner>
    where TOwner : ServedOwnerEntity, new()
{
    protected DbContext _dbContext;

    public BaseSecuredCrudRepositoryServedOwner(DbContext dbContext)
    {
